                                ...
                                >
                                    <div className='header__menu-mobile-stack'>
                                        ...
                                        <div className='header__socials'>
                                            <a href='https://t.me/+JDGX9We1dfE2ZWRk' target='_blank' rel='noopener noreferrer' aria-label='Facebook'>
                                            ...
                                            <a href='https://www.instagram.com/analyticspro._?igsh=b3RnaDI5YWRwNGhj' target='_blank' rel='noopener noreferrer' aria-label='Instagram'>
                            ...
                            <MobileDrawer.Body className={is_traders_hub_route || is_wallet_route ? 'no-padding' : ''}>
                                ...
                                <MobileDrawer.Item>
                                    ...
                                    >
                                        ...
                                        <span className='dc-menu-link__text'>{localize('ANALYTICS PRO')}</span>
                                    </a>
                                </MobileDrawer.Item>
                                ...
                                {is_logged_in && (
                                    <MobileDrawer.Item onClick={oAuthLogout} className='dc-mobile-drawer__item header__menu-mobile-logout'>
